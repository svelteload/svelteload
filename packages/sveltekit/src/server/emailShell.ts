...
// New Outlook on Windows and Outlook.com strip rules from <style> blocks. Every
// Outlook-critical rule is inlined per-element via inlineEmailStyles before the
...
// The nested <span> is load-bearing: New Outlook restyles the <a> but honors
// the inner span's inline style.
...
// Removes <p> and <li> whose visible text is empty, whitespace, or a bare
// "Label:" with no value. Auto-hides optional-field lines like {phone_number}
// when the customer left the field blank.
